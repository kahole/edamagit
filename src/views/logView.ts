...
export class CommitLongFormItemView extends CommitItemView {
  ...
  constructor(public logEntry: MagitLogEntry) {
    ...
    this.addSubview(new PlainTextView(`${truncatedMsg}${truncatedAuthor}${timeDistance}`));
